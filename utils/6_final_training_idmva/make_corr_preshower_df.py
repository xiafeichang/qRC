...
def main(options):
    ...
    cols = ['probeScEta', 'probeEtaWidth', 'probeR9', 'weight', 'probeSigmaRR', 'tagChIso03', 'probeChIso03', 'probeS4', 'tagR9', 'tagPhiWidth_Sc', 'probePt', 'tagSigmaRR', 'probePhiWidth', 'probeChIso03worst', 'puweight', 'tagEleMatch', 'tagPhi', 'probeScEnergy', 'nvtx', 'probePhoIso', 'tagPhoIso', 'run', 'tagScEta', 'probeEleMatch', 'probeCovarianceIeIp', 'tagPt', 'rho', 'tagS4', 'tagSigmaIeIe', 'tagCovarianceIpIp', 'tagCovarianceIeIp', 'tagScEnergy', 'tagChIso03worst', 'probeSigmaIeIe', 'probePhi', 'mass', 'probeCovarianceIpIp', 'tagEtaWidth_Sc', 'probeHoE', 'probeFull5x5_e1x5', 'probeFull5x5_e5x5', 'probeNeutIso', 'probePassEleVeto', 'phoIdMVA_esEnovSCRawEn']

    ss = ['probeCovarianceIeIp','probeS4','probeR9','probePhiWidth','probeSigmaIeIe','probeEtaWidth']

    qRC = quantileRegression_chain_disc(year,options.EBEE,workDir,[preshower_variable])
    qRC.kinrho += ss
    ...
    qRC.loadp0tclf(preshower_variable,weightsDir=weightsDirs)
    ...
    if options.final:
        ...
        qRC.loadFinalTailRegressor(preshower_variable,weightsDir=finalWeightsDirs)
