...
do
    ...
    do
        ...
        do
	        ...
	        sbatch SLURM/job_train_qRC_data_systematics.sh ${configSS} ${var} ${q} ${N_evts} ${EBEE} ${split}
        done
    done
done
...
do
    ...
    do
        ...
        do
	        echo Submitting training job for quantile $q split $split on data
	        sbatch SLURM/job_train_qRC_I_data_systematics.sh ${configPI} ${var} ${q} ${N_evts} ${EBEE} ${split}
        done
    done
done
...
do
    ...
    do
        ...
        do
	        echo Submitting training job for quantile $q split $split on data
	        sbatch SLURM/job_train_qRC_I_data_systematics.sh ${configCI} ${var} ${q} ${N_evts} ${EBEE} ${split}
        done
    done
done
